...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Predict matching colors using a trained model.")
    parser.add_argument(
        "color", 
        type=str, 
        help="Enter the name of the color you want to match."
    )
    
    args = parser.parse_args()
    user_input = args.color.strip()
    try:
